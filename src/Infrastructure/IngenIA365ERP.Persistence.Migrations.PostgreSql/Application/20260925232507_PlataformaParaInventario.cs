        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeCode = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: false),
                    Module = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    RecipientPermissions = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    Channels = table.Column<int>(type: "integer", nullable: false),
                    Severity = table.Column<int>(type: "integer", nullable: false),
                    ThresholdsJson = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentTypePublicId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Stream = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: false),
                    Kind = table.Column<int>(type: "integer", nullable: false),
                    Seq = table.Column<long>(type: "bigint", nullable: false),
                    Hash = table.Column<string>(type: "character(64)", unicode: false, fixedLength: true, maxLength: 64, nullable: false),
                    AnchorDate = table.Column<DateOnly>(type: "date", nullable: true),
                    Hmac = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastHash = table.Column<string>(type: "character(64)", unicode: false, fixedLength: true, maxLength: 64, nullable: false),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Forwarded = table.Column<bool>(type: "boolean", nullable: false),
                    ForwardedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ForwardAttempts = table.Column<int>(type: "integer", nullable: false),
                    LastForwardError = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Seq = table.Column<long>(type: "bigint", nullable: true),
                    PrevHash = table.Column<string>(type: "character(64)", unicode: false, fixedLength: true, maxLength: 64, nullable: true),
                    Hash = table.Column<string>(type: "character(64)", unicode: false, fixedLength: true, maxLength: 64, nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginPublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    OriginDocumentClass = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    OriginDocumentTypeCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    OriginNumber = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    OriginEventKey = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    FiscalUniqueCode = table.Column<string>(type: "character varying(96)", maxLength: 96, nullable: true),
                    RelatedPublicId = table.Column<Guid>(type: "uuid", nullable: true),
                    RelatedDocumentClass = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    RelatedNumber = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    ChainRootPublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    OperationDate = table.Column<DateOnly>(type: "date", nullable: false),
                    BranchPublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    CostCenterPublicId = table.Column<Guid>(type: "uuid", nullable: true),
                    WarehouseCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    PersonPublicId = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    PayloadSha256 = table.Column<string>(type: "character(64)", unicode: false, fixedLength: true, maxLength: 64, nullable: false),
                    PrevalidationOutcome = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Module = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    ...
                    LegalSource = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Kind = table.Column<int>(type: "integer", nullable: false),
                    CalculationForm = table.Column<int>(type: "integer", nullable: false),
                    TaxedOnDefinitionId = table.Column<int>(type: "integer", nullable: true),
                    IsWithholding = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    DianTaxCode = table.Column<string>(type: "character varying(4)", maxLength: 4, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScopeWarehousePublicId = table.Column<Guid>(type: "uuid", nullable: true),
                    ScopePointOfSalePublicId = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    RaisedByKind = table.Column<int>(type: "integer", nullable: false),
                    ...
                    AttendedByKind = table.Column<int>(type: "integer", nullable: true),
                    AttendedByUserId = table.Column<int>(type: "integer", nullable: true),
                    AttendedByName = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    AttendNote = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    RecipientCount = table.Column<int>(type: "integer", nullable: false),
                    WithoutRecipient = table.Column<bool>(type: "boolean", nullable: false),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceLabel = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    ScopeWarehousePublicId = table.Column<Guid>(type: "uuid", nullable: true),
                    ScopePointOfSalePublicId = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    RequiredLevelsJson = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    CreatedByUserId = table.Column<int>(type: "integer", nullable: false),
                    RequestedByUserId = table.Column<int>(type: "integer", nullable: false),
                    ExcludedUserIdsJson = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    CurrentLevel = table.Column<byte>(type: "smallint", nullable: false),
                    ContentSha256 = table.Column<string>(type: "character(64)", unicode: false, fixedLength: true, maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BatchScopeKey = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: true),
                    ...
                    LastErrorDataJson = table.Column<string>(type: "text", nullable: true),
                    ProcessedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ResultReference = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ResultVoucherTypeCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    ResultVoucherNumber = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_COR_IntegrationMessageDeliveries_COR_IntegrationMessages_Me~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_COR_IntegrationMessageDependencies_COR_IntegrationMessages_~",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_COR_IntegrationMessageDependencies_COR_IntegrationMessages~1",
                        column: x => x.MessageId,
                        principalSchema: "dbo",
                        principalTable: "COR_IntegrationMessages",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumBaseUvt = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: true),
                    MinimumBasePesos = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    SubjectPersonType = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: true),
                    SubjectIsIncomeTaxFiler = table.Column<bool>(type: "boolean", nullable: true),
                    SubjectIsVatResponsible = table.Column<bool>(type: "boolean", nullable: true),
                    SubjectIsLargeContributor = table.Column<bool>(type: "boolean", nullable: true),
                    SubjectIsSelfWithholder = table.Column<bool>(type: "boolean", nullable: true),
                    SubjectIsSimpleTaxRegime = table.Column<bool>(type: "boolean", nullable: true),
                    AgentIsLargeContributor = table.Column<bool>(type: "boolean", nullable: true),
                    AgentIsVatWithholdingAgent = table.Column<bool>(type: "boolean", nullable: true),
                    ...
                    ReviewPending = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    Notes = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CredentialPublicId = table.Column<Guid>(type: "uuid", nullable: true),
                    PermissionCodeUsed = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ContentSha256 = table.Column<string>(type: "character(64)", unicode: false, fixedLength: true, maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "DaneCode",
                unique: true,
                filter: "\"DaneCode\" IS NOT NULL AND \"IsDeleted\" = FALSE");
...
SELECT v.name, NULL, TIMESTAMPTZ '2000-01-01 00:00:00+00', gen_random_uuid(), FALSE, now(), 'SYSTEM'
FROM (VALUES ('integration.dispatch'), ('audit.forward'), ('einvoicing.process'), ('scheduled.tasks'), ('email.dispatch')) AS v(name)
