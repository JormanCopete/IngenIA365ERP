    ...
    public partial class BaseLegal2026Corregida : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                ...
                WHERE "Code" = 'HORAS_MES' AND "ValidFrom" = TIMESTAMP '2026-01-01'
                  AND "Value" = 240 AND "CreatedBy" = 'system:seed';

                UPDATE dbo."PAY_ConceptDefinitions" c
                SET "UnitFactor" = v.nuevo, "UpdatedBy" = 'system:seed', "UpdatedAt" = (now() at time zone 'utc')
                FROM (VALUES ('RECARGO_DOMINICAL', 0.75, 0.80),
                             ('HEX_DOM_DIURNA',    2.00, 2.05),
                             ('HEX_DOM_NOCTURNA',  2.50, 2.55)) AS v(code, viejo, nuevo)
                WHERE c."Code" = v.code AND c."ValidFrom" = TIMESTAMP '2026-01-01'
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                UPDATE dbo."PAY_LegalParameters"
                SET "Value" = 240, "UpdatedBy" = 'system:seed', "UpdatedAt" = (now() at time zone 'utc')
                WHERE "Code" = 'HORAS_MES' AND "ValidFrom" = TIMESTAMP '2026-01-01'
                ...
                FROM (VALUES ('RECARGO_DOMINICAL', 0.75, 0.80),
                             ...
                             ('HEX_DOM_NOCTURNA',  2.50, 2.55)) AS v(code, viejo, nuevo)
                WHERE c."Code" = v.code AND c."ValidFrom" = TIMESTAMP '2026-01-01'
                  AND c."Origin" = 0 AND c."UnitFactor" = v.nuevo;
                """);
