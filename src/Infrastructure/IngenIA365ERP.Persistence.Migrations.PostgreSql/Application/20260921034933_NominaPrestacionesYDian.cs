    ...
    public partial class NominaPrestacionesYDian : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PendingVacationDays = table.Column<decimal>(type: "numeric(8,2)", precision: 8, scale: 2, nullable: false),
                    AccruedSeverance = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    AccruedSeveranceInterest = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    AccruedServiceBonus = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    ServiceBonusDaysAccrued = table.Column<int>(type: "integer", nullable: true),
                    SeveranceDaysAccrued = table.Column<int>(type: "integer", nullable: true),
                    Notes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    AdjustsBalanceId = table.Column<int>(type: "integer", nullable: true),
                    AdjustmentReason = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PAY_EmployeeBenefitOpeningBalances_PAY_EmployeeBenefitOpeni~",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PAY_EmployeeBenefitOpeningBalances_PAY_PayrollRuns_Consumed~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeveranceFundId = table.Column<int>(type: "integer", nullable: false),
                    DepositedAt = table.Column<DateOnly>(type: "date", nullable: false),
                    DepositedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PAY_SeveranceFundDeposits_PAY_SeveranceProviders_SeveranceF~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GeneratesSeverancePay = table.Column<bool>(type: "boolean", nullable: false),
                    RequiresContractEndDate = table.Column<bool>(type: "boolean", nullable: false),
                    LegalBasis = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessDays = table.Column<decimal>(type: "numeric(8,2)", precision: 8, scale: 2, nullable: false),
                    CalendarDays = table.Column<int>(type: "integer", nullable: false),
                    WeekPolicyUsed = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    SkippedDaysJson = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetSemester = table.Column<byte>(type: "smallint", nullable: false),
                    Version = table.Column<int>(type: "integer", nullable: false),
                    CalculatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CalculatedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    MonthsConsidered = table.Column<byte>(type: "smallint", nullable: false),
                    Divisor = table.Column<decimal>(type: "numeric(6,2)", precision: 6, scale: 2, nullable: false),
                    TotalGrossIncome = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalMandatoryContributions = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalDeclaredDeductions = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalExemptIncome = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    DepuratedBase = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    AverageMonthlyBase = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    UvtValueUsed = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
                    AverageInUvt = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
                    TheoreticalWithholding = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    RatePercent = table.Column<decimal>(type: "numeric(6,3)", precision: 6, scale: 3, nullable: false),
                    DepurationSequence = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    TableParameterId = table.Column<int>(type: "integer", nullable: false),
                    PlanTableUsed = table.Column<bool>(type: "boolean", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    ApprovedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ApprovedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    RejectReason = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    ResultingRateId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PAY_WithholdingRateCalculations_PAY_EmployeeWithholdingRate~",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PAY_WithholdingRateCalculations_PAY_LegalParameters_TablePa~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TerminationReasonId = table.Column<int>(type: "integer", nullable: false),
                    ContractTypeAtTermination = table.Column<int>(type: "integer", nullable: true),
                    ContractEndDate = table.Column<DateOnly>(type: "date", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    Notes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    SettlementDocumentAttachmentPublicId = table.Column<Guid>(type: "uuid", nullable: true),
                    SignedDocumentAttachmentPublicId = table.Column<Guid>(type: "uuid", nullable: true),
                    ReinstatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ReinstatedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ReinstateReason = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PAY_EmploymentTerminations_PAY_TerminationReasons_Terminati~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MandatoryContributions = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    IncludedSpecialRuns = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PAY_WithholdingRateCalculationMonths_PAY_WithholdingRateCal~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TerminationId = table.Column<int>(type: "integer", nullable: false),
                    Kind = table.Column<int>(type: "integer", nullable: false),
                    ...
                    ProposedBreakdownJson = table.Column<string>(type: "text", nullable: true),
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    CarteraTransactionPublicId = table.Column<Guid>(type: "uuid", nullable: true),
                    RemainingBalanceAfter = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PAY_SettlementDeductions_PAY_EmploymentTerminations_Termina~",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PAY_SettlementDeductions_PAY_RecurringNovelties_RecurringNo~",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_PAY_EmployeeWithholdingRates_PAY_WithholdingRateCalculation~",
                schema: "dbo",
                table: "PAY_EmployeeWithholdingRates",
                column: "SourceCalculationId",
                principalSchema: "dbo",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_PAY_PayrollRunLines_PAY_SettlementDeductions_SettlementDedu~",
                schema: "dbo",
                table: "PAY_PayrollRunLines",
                column: "SettlementDeductionId",
                principalSchema: "dbo",
            ...
            migrationBuilder.Sql("""
                ...
                WHERE s."SettingKey" = 'Payroll.ApplyEmployerExemption' AND s."IsDeleted" = FALSE
                  ...
                  AND NOT EXISTS (SELECT 1 FROM dbo."PAY_CompanyPolicies" p WHERE p."Key" = 'Exonerada114_1' AND p."IsDeleted" = FALSE);
                """);
            migrationBuilder.Sql("""
                INSERT INTO dbo."PAY_CompanyPolicies" ("Key", "Value", "ValidFrom", "ValidTo", "Notes", "PublicId", "IsDeleted", "CreatedAt", "CreatedBy")
                ...
                WHERE s."SettingKey" = 'Payroll.AllowSameUserApproval' AND s."IsDeleted" = FALSE
                  AND LOWER(TRIM(s."SettingValue")) IN ('true', 'false')
                  AND NOT EXISTS (SELECT 1 FROM dbo."PAY_CompanyPolicies" p WHERE p."Key" = 'AllowSameUserApproval' AND p."IsDeleted" = FALSE);
                """);
            ...
            migrationBuilder.Sql("""
                UPDATE dbo."PAY_Employees" e
                SET "DisbursementBankId" = b."Id"
                FROM dbo."COR_Banks" b
                WHERE e."DisbursementBankId" IS NULL
                  AND e."PayrollBankId" IS NOT NULL AND TRIM(e."PayrollBankId") <> ''
            ...
            migrationBuilder.Sql("""
                UPDATE dbo."PAY_LegalParameters" SET "ValidTo" = TIMESTAMPTZ '2027-03-31 00:00:00+00'
                WHERE "Code" = 'FSP_TABLA' AND "ValidTo" IS NULL AND "IsDeleted" = FALSE
                  AND "ValidFrom" < TIMESTAMPTZ '2027-04-01 00:00:00+00';
                """);
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                DO $$
                BEGIN
                    IF EXISTS (SELECT 1 FROM dbo."PAY_PayrollRuns" WHERE "Kind" <> 0) THEN
                        RAISE EXCEPTION 'NominaPrestacionesYDian: existen corridas con Kind distinto de 0 (prima, cesantias, vacaciones o definitiva). La migracion solo es reversible sin liquidaciones especiales (feature 010, D-13). Respalde, reverse o descarte esas corridas con el dueno y decida antes de continuar.';
                    END IF;
                END $$;
                """);
