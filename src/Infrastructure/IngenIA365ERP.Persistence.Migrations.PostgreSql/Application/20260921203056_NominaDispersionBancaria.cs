        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Delimiter = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: true),
                    QuoteText = table.Column<bool>(type: "boolean", nullable: false),
                    Encoding = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    LineEnding = table.Column<int>(type: "integer", nullable: false),
                    Uppercase = table.Column<bool>(type: "boolean", nullable: false),
                    StripAccents = table.Column<bool>(type: "boolean", nullable: false),
                    AmountFormat = table.Column<int>(type: "integer", nullable: false),
                    FileNamePattern = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    ...
                    HasTrailer = table.Column<bool>(type: "boolean", nullable: false),
                    AgreementCode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConstantValue = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
                    Length = table.Column<int>(type: "integer", nullable: true),
                    Alignment = table.Column<int>(type: "integer", nullable: false),
                    PadChar = table.Column<string>(type: "character varying(1)", maxLength: 1, nullable: false),
                    DataType = table.Column<int>(type: "integer", nullable: false),
                    ValueFormat = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    ValueMapJson = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: true),
                    Required = table.Column<bool>(type: "boolean", nullable: false),
                    Truncate = table.Column<bool>(type: "boolean", nullable: false),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankId = table.Column<int>(type: "integer", nullable: true),
                    FormatId = table.Column<int>(type: "integer", nullable: false),
                    FormatCode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ...
                    SourceAccountNumber = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    ...
                    ExcludedJson = table.Column<string>(type: "text", nullable: true),
                    ...
                    SentNotes = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DestinationBankId = table.Column<int>(type: "integer", nullable: true),
                    AccountType = table.Column<int>(type: "integer", nullable: false),
                    AccountNumber = table.Column<string>(type: "character varying(25)", maxLength: 25, nullable: true),
                    Amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    RecordText = table.Column<string>(type: "character varying(600)", maxLength: 600, nullable: false),
                    PayrollPaymentId = table.Column<int>(type: "integer", nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PAY_BankDisbursementFileLines_PAY_BankDisbursementFiles_Fil~",
                        column: x => x.FileId,
                        principalSchema: "dbo",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PAY_BankDisbursementFileLines_PAY_PayrollPayments_PayrollPa~",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PAY_BankDisbursementFileLines_PAY_PayrollRunEmployees_Payro~",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_PAY_PayrollPayments_PAY_BankDisbursementFiles_BankDisbursem~",
                schema: "dbo",
                table: "PAY_PayrollPayments",
                column: "BankDisbursementFileId",
                principalSchema: "dbo",
