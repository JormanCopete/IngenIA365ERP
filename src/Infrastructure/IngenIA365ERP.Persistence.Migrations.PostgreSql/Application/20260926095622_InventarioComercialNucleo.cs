...
namespace IngenIA365ERP.Persistence.Migrations.PostgreSql.Application
{
    ...
    /// (van en <c>PlataformaParaInventario</c>) ni de I2–I6. En PostgreSQL crea antes la extensión <c>pg_trgm</c> (<c>CREATE EXTENSION IF NOT EXISTS</c>) que usa el índice GIN
    /// <c>IX_INV_Products_SearchText</c> (<c>gin_trgm_ops</c>); <c>Down()</c> no la suelta, porque otra cosa puede usarla. Sin marcador destructivo: <c>Down()</c> quita sólo lo agregado
    ...
    public partial class InventarioComercialNucleo : Migration
    {
        ...
        {
            // La búsqueda de productos (T206, T43) usa trigramas: la extensión tiene que existir antes del índice GIN.
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowsPositive = table.Column<bool>(type: "boolean", nullable: false),
                    AllowsNegative = table.Column<bool>(type: "boolean", nullable: false),
                    AllowsTransitWriteOff = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    IsRequiredBySystem = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CloseVersion = table.Column<int>(type: "integer", nullable: false),
                    ClosedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ClosedByUserId = table.Column<int>(type: "integer", nullable: true),
                    CloseWarningsJson = table.Column<string>(type: "text", nullable: true),
                    UnbilledShipmentsJson = table.Column<string>(type: "text", nullable: true),
                    UnbilledShipmentsAcceptedByUserId = table.Column<int>(type: "integer", nullable: true),
                    UnbilledShipmentsAcceptedReason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedDecimals = table.Column<byte>(type: "smallint", nullable: false),
                    DianUnitCode = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: true),
                    IsSeeded = table.Column<bool>(type: "boolean", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FiscalPrefix = table.Column<string>(type: "character varying(4)", maxLength: 4, nullable: true),
                    IsContingency = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    RequiresCounterparty = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    RequiresExternalReference = table.Column<bool>(type: "boolean", nullable: false),
                    SalesChannelId = table.Column<int>(type: "integer", nullable: true),
                    IsTaxableWithdrawal = table.Column<bool>(type: "boolean", nullable: false),
                    VatNonDeductible = table.Column<bool>(type: "boolean", nullable: false),
                    AllowsFutureDate = table.Column<bool>(type: "boolean", nullable: false),
                    AllWarehouses = table.Column<bool>(type: "boolean", nullable: false),
                    IsSeeded = table.Column<bool>(type: "boolean", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountingGroupId = table.Column<int>(type: "integer", nullable: true),
                    VatSaleTreatment = table.Column<int>(type: "integer", nullable: false),
                    WithholdingConceptId = table.Column<int>(type: "integer", nullable: true),
                    ...
                    TracksLot = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    TracksSerial = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    ...
                    SearchText = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScopeWarehouseId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    LastUnitCost = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: false),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ProductId = table.Column<int>(type: "integer", nullable: false),
                    FromAccountingGroupId = table.Column<int>(type: "integer", nullable: false),
                    ToAccountingGroupId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_INV_ProductAccountingGroupChanges_INV_AccountingGroups_From~",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_INV_ProductAccountingGroupChanges_INV_AccountingGroups_ToAc~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxableUnitsPerBaseUnit = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsedForPurchase = table.Column<bool>(type: "boolean", nullable: false),
                    UsedForSale = table.Column<bool>(type: "boolean", nullable: false),
                    IsDefaultPurchase = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscardReason = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    WarehouseId = table.Column<int>(type: "integer", nullable: true),
                    DestinationWarehouseId = table.Column<int>(type: "integer", nullable: true),
                    TransitWarehouseId = table.Column<int>(type: "integer", nullable: true),
                    BranchId = table.Column<int>(type: "integer", nullable: false),
                    CostCenterId = table.Column<int>(type: "integer", nullable: true),
                    CounterpartyPersonId = table.Column<int>(type: "integer", nullable: true),
                    ...
                    PostingMode = table.Column<int>(type: "integer", nullable: true),
                    Reason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    VoidsDocumentId = table.Column<int>(type: "integer", nullable: true),
                    VoidedByDocumentId = table.Column<int>(type: "integer", nullable: true),
                    FiscalNumberReleased = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    OperationMunicipalityDaneCode = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: true),
                    ...
                    WithholdingTotal = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    ...
                    CountKind = table.Column<int>(type: "integer", nullable: true),
                    CountScope = table.Column<int>(type: "integer", nullable: true),
                    CountScopeJson = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: true),
                    IsBlindCount = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    CountSnapshotAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CountSnapshotKardexEntryId = table.Column<long>(type: "bigint", nullable: true),
                    CountRound = table.Column<byte>(type: "smallint", nullable: true),
                    ValidUntil = table.Column<DateOnly>(type: "date", nullable: true),
                    DueDate = table.Column<DateOnly>(type: "date", nullable: true),
                    ReturnsGoods = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    IsFullReversal = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    CorrectionConceptCode = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ImportBatchPublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    AsOfDate = table.Column<DateOnly>(type: "date", nullable: false),
                    FromDate = table.Column<DateOnly>(type: "date", nullable: true),
                    ProductCodeRaw = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    WarehouseCodeRaw = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ...
                    QuantityIn = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: true),
                    QuantityOut = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: true),
                    ValueIn = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ValueOut = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "integer", nullable: false),
                    WarehouseId = table.Column<int>(type: "integer", nullable: false),
                    AccountingGroupId = table.Column<int>(type: "integer", nullable: false),
                    Quantity = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
                    Value = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_INV_PeriodClosingBalances_INV_AccountingGroups_AccountingGr~",
                        column: x => x.AccountingGroupId,
                        principalSchema: "dbo",
                        principalTable: "INV_AccountingGroups",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaximumQuantity = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "integer", nullable: false),
                    WarehouseId = table.Column<int>(type: "integer", nullable: false),
                    Physical = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DifferenceAcceptedByUserId = table.Column<int>(type: "integer", nullable: true),
                    AcceptanceReason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DianOrganizationType = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: false),
                    DianIdTypeCode = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
                    TaxId = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    CheckDigit = table.Column<string>(type: "character(1)", fixedLength: true, maxLength: 1, nullable: true),
                    ...
                    Address = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    MunicipalityDaneCode = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: true),
                    ...
                    DianResponsibilities = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    DianTaxSchemeCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    IsVatResponsible = table.Column<bool>(type: "boolean", nullable: false),
                    IsLargeContributor = table.Column<bool>(type: "boolean", nullable: false),
                    IsSelfWithholder = table.Column<bool>(type: "boolean", nullable: false),
                    IsVatWithholdingAgent = table.Column<bool>(type: "boolean", nullable: false),
                    IsSimpleTaxRegime = table.Column<bool>(type: "boolean", nullable: false),
                    IsIncomeTaxFiler = table.Column<bool>(type: "boolean", nullable: false),
                    WithholdingExempt = table.Column<bool>(type: "boolean", nullable: false),
                    IcaWithholdingExempt = table.Column<bool>(type: "boolean", nullable: false),
                    CiiuCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    ChangeReason = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DocumentId = table.Column<int>(type: "integer", nullable: false),
                    DocumentClass = table.Column<int>(type: "integer", nullable: false),
                    SupplierPersonId = table.Column<int>(type: "integer", nullable: false),
                    SupplierPrefix = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    SupplierNumber = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Cufe = table.Column<string>(type: "character varying(96)", maxLength: 96, nullable: true),
                    ...
                    IsDebitNote = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cude = table.Column<string>(type: "character varying(96)", maxLength: 96, nullable: true),
                    ...
                    EvidenceAttachmentPublicId = table.Column<Guid>(type: "uuid", nullable: true),
                    ElectronicDocumentPublicId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SnapshotUnitCost = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: false),
                    AddedDuringCapture = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    MovementsAfterSnapshot = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: true),
                    ...
                    RecountRequired = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    LastRound = table.Column<byte>(type: "smallint", nullable: false, defaultValue: (byte)0),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoundingQuantity = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
                    UnitPrice = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: false),
                    ListPriceIncludesTaxes = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    ...
                    AdjustmentCauseId = table.Column<int>(type: "integer", nullable: true),
                    Description = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    AffectsCost = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DocumentId = table.Column<int>(type: "integer", nullable: false),
                    SnapshotLineId = table.Column<int>(type: "integer", nullable: false),
                    Round = table.Column<byte>(type: "smallint", nullable: false),
                    CounterUserId = table.Column<int>(type: "integer", nullable: false),
                    Quantity = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DocumentLinkId = table.Column<int>(type: "integer", nullable: false),
                    SourceLineId = table.Column<int>(type: "integer", nullable: false),
                    TargetLineId = table.Column<int>(type: "integer", nullable: false),
                    QuantityBase = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DocumentId = table.Column<int>(type: "integer", nullable: false),
                    DocumentLineId = table.Column<int>(type: "integer", nullable: true),
                    TaxDefinitionId = table.Column<int>(type: "integer", nullable: false),
                    TaxRateId = table.Column<int>(type: "integer", nullable: false),
                    TaxRateCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    Kind = table.Column<int>(type: "integer", nullable: false),
                    ...
                    AmountPerUnit = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    TaxableUnits = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: true),
                    Base = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    Amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    DianTaxCode = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_INV_DocumentTaxLines_COR_WithholdingConcepts_WithholdingCon~",
                        column: x => x.WithholdingConceptId,
                        principalSchema: "dbo",
                        principalTable: "COR_WithholdingConcepts",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostScopeWarehouseId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DispatchDocumentId = table.Column<int>(type: "integer", nullable: false),
                    ReceiptDocumentId = table.Column<int>(type: "integer", nullable: false),
                    DispatchLineId = table.Column<int>(type: "integer", nullable: false),
                    ProductId = table.Column<int>(type: "integer", nullable: false),
                    LotId = table.Column<int>(type: "integer", nullable: true),
                    Kind = table.Column<int>(type: "integer", nullable: false),
                    QuantityBase = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
                    UnitCost = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                    ResolvedQuantityBase = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false, defaultValue: 0m),
                    Resolution = table.Column<int>(type: "integer", nullable: true),
                    ResolutionQuantityBase = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: true),
                    ResolutionRequestedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ResolutionRequestedByUserId = table.Column<int>(type: "integer", nullable: true),
                    ResolutionReason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    AdjustmentCauseId = table.Column<int>(type: "integer", nullable: true),
                    ResolutionDocumentId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_INV_TransferDiscrepancies_INV_AdjustmentCauses_AdjustmentCa~",
                        column: x => x.AdjustmentCauseId,
                        principalSchema: "dbo",
                        principalTable: "INV_AdjustmentCauses",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "\"Number\" IS NOT NULL AND \"FiscalNumberReleased\" = FALSE");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "ProductId",
                unique: true,
                filter: "\"IsDefaultPurchase\" = TRUE AND \"IsDeleted\" = FALSE");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "ProductId",
                unique: true,
                filter: "\"IsDefaultSale\" = TRUE AND \"IsDeleted\" = FALSE");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "Cufe",
                unique: true,
                filter: "\"Cufe\" IS NOT NULL AND \"IsReleased\" = FALSE AND \"IsDeleted\" = FALSE");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "\"IsReleased\" = FALSE AND \"IsDeleted\" = FALSE");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "BranchId",
                unique: true,
                filter: "\"Behavior\" = 2 AND \"IsDeleted\" = FALSE");
