        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    EmployerTaxId = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: false),
                    EmployerCheckDigit = table.Column<string>(type: "character varying(1)", maxLength: 1, nullable: false),
                    EmployerBusinessName = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    EmployerMunicipalityDaneCode = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: false),
                    EmployerAddress = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    EmployerCountryCode = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: false),
                    ...
                    TestSetStatus = table.Column<int>(type: "integer", nullable: false),
                    TestSetAcceptedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    TestSetResultJson = table.Column<string>(type: "text", nullable: true),
                    CertificateSecretName = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
                    PinSecretName = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
                    CertificateThumbprint = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    ...
                    EnabledBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LayoutVersion = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    GeneratedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    GeneratedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ExemptionApplied = table.Column<bool>(type: "boolean", nullable: false),
                    ContributorCount = table.Column<int>(type: "integer", nullable: false),
                    LineCount = table.Column<int>(type: "integer", nullable: false),
                    TotalIbcHealth = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalIbcPension = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalIbcWorkRisk = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalIbcFamilyCompensation = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalHealth = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalPension = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalSolidarityFund = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalWorkRisk = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalFamilyCompensation = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalSena = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalIcbf = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    ...
                    SourceRunsJson = table.Column<string>(type: "text", nullable: false),
                    ...
                    FileAttachmentPublicId = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    OperatorFilingNumber = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ContributorType = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: false),
                    ContributorClass = table.Column<string>(type: "character varying(1)", maxLength: 1, nullable: false),
                    PresentationForm = table.Column<string>(type: "character varying(1)", maxLength: 1, nullable: false),
                    BranchCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    BranchName = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    ArlPilaCode = table.Column<string>(type: "character varying(6)", maxLength: 6, nullable: true),
                    MunicipalityDaneCode = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: true),
                    EconomicActivityCode = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: true),
                    OperatorName = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    OperatorCode = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: true),
                    PlanillaType = table.Column<string>(type: "character varying(1)", maxLength: 1, nullable: false),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdjustsDocumentId = table.Column<int>(type: "integer", nullable: true),
                    ReplacedByDocumentId = table.Column<int>(type: "integer", nullable: true),
                    NumberingRangeId = table.Column<int>(type: "integer", nullable: false),
                    Prefix = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    ...
                    GenerationTime = table.Column<TimeOnly>(type: "time without time zone", nullable: false),
                    Cune = table.Column<string>(type: "character varying(96)", maxLength: 96, nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    AttemptCount = table.Column<int>(type: "integer", nullable: false),
                    LastTransmissionId = table.Column<int>(type: "integer", nullable: true),
                    TotalAccrued = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    ...
                    PaymentDatesJson = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
                    SourceRunsJson = table.Column<string>(type: "text", nullable: false),
                    SourceFingerprint = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    UnsignedXmlAttachmentPublicId = table.Column<Guid>(type: "uuid", nullable: true),
                    SignedXmlAttachmentPublicId = table.Column<Guid>(type: "uuid", nullable: true),
                    ZipAttachmentPublicId = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    ZipKey = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    DianStatusCode = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: true),
                    DianStatusDescription = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    AcceptedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    TranslatedErrorsJson = table.Column<string>(type: "text", nullable: true),
                    QrUrl = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PAY_ElectronicPayrollDocuments_PAY_ElectronicPayrollDocumen~",
                    ...
                    table.ForeignKey(
                        name: "FK_PAY_ElectronicPayrollDocuments_PAY_ElectronicPayrollNumberi~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeId = table.Column<int>(type: "integer", nullable: false),
                    ContributorType = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: false),
                    ContributorSubType = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: false),
                    NoveltyFlags = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: false),
                    DaysHealth = table.Column<byte>(type: "smallint", nullable: false),
                    DaysPension = table.Column<byte>(type: "smallint", nullable: false),
                    DaysWorkRisk = table.Column<byte>(type: "smallint", nullable: false),
                    DaysFamilyCompensation = table.Column<byte>(type: "smallint", nullable: false),
                    Salary = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    IbcHealth = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    IbcPension = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    IbcWorkRisk = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    IbcFamilyCompensation = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    HealthRate = table.Column<decimal>(type: "numeric(9,7)", precision: 9, scale: 7, nullable: false),
                    PensionRate = table.Column<decimal>(type: "numeric(9,7)", precision: 9, scale: 7, nullable: false),
                    WorkRiskRate = table.Column<decimal>(type: "numeric(9,7)", precision: 9, scale: 7, nullable: false),
                    FamilyCompensationRate = table.Column<decimal>(type: "numeric(9,7)", precision: 9, scale: 7, nullable: false),
                    SenaRate = table.Column<decimal>(type: "numeric(9,7)", precision: 9, scale: 7, nullable: false),
                    IcbfRate = table.Column<decimal>(type: "numeric(9,7)", precision: 9, scale: 7, nullable: false),
                    Health = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    Pension = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    SolidarityFund = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    SubsistenceFund = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    WorkRisk = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    FamilyCompensation = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    Sena = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    Icbf = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    Exempt = table.Column<bool>(type: "boolean", nullable: false),
                    FieldsJson = table.Column<string>(type: "text", nullable: false),
                    RecordText = table.Column<string>(type: "character varying(800)", maxLength: 800, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FieldNumber = table.Column<byte>(type: "smallint", nullable: true),
                    EmployeeId = table.Column<int>(type: "integer", nullable: true),
                    Message = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    LinkRoute = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Environment = table.Column<int>(type: "integer", nullable: false),
                    ServiceCorrelationId = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    RawErrorsJson = table.Column<string>(type: "text", nullable: true),
                    TranslatedErrorsJson = table.Column<string>(type: "text", nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    PublicId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PAY_ElectronicPayrollTransmissions_PAY_ElectronicPayrollDoc~",
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "PilaCode",
                unique: true,
                filter: "\"PilaCode\" IS NOT NULL AND \"IsDeleted\" = FALSE");
