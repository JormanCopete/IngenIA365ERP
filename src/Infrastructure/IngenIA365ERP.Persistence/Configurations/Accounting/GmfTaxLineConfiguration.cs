...
public class GmfTaxLineConfiguration : IEntityTypeConfiguration<GmfTaxLine>
{
    public void Configure(EntityTypeBuilder<GmfTaxLine> builder)
    {
        builder.ToTable("ACC_GmfTaxLines");
        builder.HasKey(e => e.Id);
        builder.Property(e => e.Id).UseIdentityColumn();

        builder.Property(e => e.PublicId).HasDefaultValueSql("NEWID()");
        builder.HasIndex(e => e.PublicId).IsUnique().HasDatabaseName("UK_ACC_GmfTaxLines_PublicId");
        ...
        builder.HasIndex(e => e.LineCode).IsUnique().HasDatabaseName("UK_ACC_GmfTaxLines_LineCode");
