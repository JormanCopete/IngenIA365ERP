...
public class VatTaxLineConfiguration : IEntityTypeConfiguration<VatTaxLine>
{
    public void Configure(EntityTypeBuilder<VatTaxLine> builder)
    {
        builder.ToTable("ACC_VatTaxLines");
        builder.HasKey(e => e.Id);
        builder.Property(e => e.Id).UseIdentityColumn();

        builder.Property(e => e.PublicId).HasDefaultValueSql("NEWID()");
        builder.HasIndex(e => e.PublicId).IsUnique().HasDatabaseName("UK_ACC_VatTaxLines_PublicId");
        ...
        builder.HasIndex(e => e.LineCode).IsUnique().HasDatabaseName("UK_ACC_VatTaxLines_LineCode");
