...
public class IcaTaxLineConfiguration : IEntityTypeConfiguration<IcaTaxLine>
{
    public void Configure(EntityTypeBuilder<IcaTaxLine> builder)
    {
        builder.ToTable("ACC_IcaTaxLines");
        builder.HasKey(e => e.Id);
        builder.Property(e => e.Id).UseIdentityColumn();

        builder.Property(e => e.PublicId);
        builder.HasIndex(e => e.PublicId).IsUnique().HasDatabaseName("UK_ACC_IcaTaxLines_PublicId");
        ...
        builder.HasIndex(e => e.LineCode).IsUnique().HasDatabaseName("UK_ACC_IcaTaxLines_LineCode");
