...
public class MasterChangeConfiguration : IEntityTypeConfiguration<MasterChange>
{
    public void Configure(EntityTypeBuilder<MasterChange> builder)
    {
        builder.ToTable("AUD_MasterChanges");
