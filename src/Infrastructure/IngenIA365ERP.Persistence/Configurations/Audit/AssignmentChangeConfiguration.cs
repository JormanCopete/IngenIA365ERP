...
public class AssignmentChangeConfiguration : IEntityTypeConfiguration<AssignmentChange>
{
    public void Configure(EntityTypeBuilder<AssignmentChange> builder)
    {
        builder.ToTable("AUD_AssignmentChanges");
