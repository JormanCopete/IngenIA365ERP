...
public class MenuChangeConfiguration : IEntityTypeConfiguration<MenuChange>
{
    public void Configure(EntityTypeBuilder<MenuChange> builder)
    {
        builder.ToTable("AUD_MenuChanges");
