...
public class CompanyChangeConfiguration : IEntityTypeConfiguration<CompanyChange>
{
    public void Configure(EntityTypeBuilder<CompanyChange> builder)
    {
        builder.ToTable("AUD_CompanyChanges");
