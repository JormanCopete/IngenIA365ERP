...
public class DefaultChangeConfiguration : IEntityTypeConfiguration<DefaultChange>
{
    public void Configure(EntityTypeBuilder<DefaultChange> builder)
    {
        builder.ToTable("AUD_DefaultChanges");
