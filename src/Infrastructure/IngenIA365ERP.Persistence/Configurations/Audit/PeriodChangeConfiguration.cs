...
public class PeriodChangeConfiguration : IEntityTypeConfiguration<PeriodChange>
{
    public void Configure(EntityTypeBuilder<PeriodChange> builder)
    {
        builder.ToTable("AUD_PeriodChanges");
