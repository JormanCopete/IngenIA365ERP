...
public class LegalAdvisorConfiguration : IEntityTypeConfiguration<LegalAdvisor>
{
    public void Configure(EntityTypeBuilder<LegalAdvisor> builder)
    {
        builder.ToTable("COR_LegalAdvisors");
        builder.HasKey(e => e.Id);
        builder.Property(e => e.Id).UseIdentityColumn();

        builder.Property(e => e.PublicId);
        builder.HasIndex(e => e.PublicId).IsUnique().HasDatabaseName("UK_COR_LegalAdvisors_PublicId");
        ...
        builder.Property(e => e.TaxId).HasMaxLength(30);
