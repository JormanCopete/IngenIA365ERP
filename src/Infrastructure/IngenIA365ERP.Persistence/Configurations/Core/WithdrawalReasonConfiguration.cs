...
public class WithdrawalReasonConfiguration : IEntityTypeConfiguration<WithdrawalReason>
{
    public void Configure(EntityTypeBuilder<WithdrawalReason> builder)
    {
        builder.ToTable("COR_WithdrawalReasons");
        builder.HasKey(e => e.Id);
        builder.Property(e => e.Id).UseIdentityColumn();

        builder.Property(e => e.PublicId);
        builder.HasIndex(e => e.PublicId).IsUnique().HasDatabaseName("UK_COR_WithdrawalReasons_PublicId");
