...
namespace IngenIA365ERP.Persistence.Migrations.SqlServer.Application
{
    ...
    public partial class HorasMesBase2026 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                ...
                WHERE Code = 'HORAS_MES' AND ValidFrom = '2026-01-01'
                  AND [Value] = 240 AND [Source] = N'Código Sustantivo del Trabajo y Ley 50 de 1990';
                """);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                UPDATE dbo.PAY_LegalParameters
                SET [Value] = 240, [Source] = N'Código Sustantivo del Trabajo y Ley 50 de 1990',
                    UpdatedBy = 'system:seed', UpdatedAt = SYSUTCDATETIME()
                WHERE Code = 'HORAS_MES' AND ValidFrom = '2026-01-01'
                  AND [Value] = 220 AND [Source] = N'Ley 2101 de 2021 (jornada de 44 h desde el 15/07/2025)';
                """);
