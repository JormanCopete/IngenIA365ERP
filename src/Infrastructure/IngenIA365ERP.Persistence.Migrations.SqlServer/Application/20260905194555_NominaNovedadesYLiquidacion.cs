        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConceptCode = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountParameterCode = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    ProrateByDays = table.Column<bool>(type: "bit", nullable: false),
                    BaseKind = table.Column<int>(type: "int", nullable: true),
                    Percent = table.Column<decimal>(type: "decimal(9,4)", precision: 9, scale: 4, nullable: true),
                    PercentParameterCode = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    UnitKind = table.Column<int>(type: "int", nullable: true),
                    UnitFactor = table.Column<decimal>(type: "decimal(9,4)", precision: 9, scale: 4, nullable: true),
                    TableParameterCode = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    ComponentConceptCodes = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    AffectsSalaryBase = table.Column<bool>(type: "bit", nullable: false),
                    AffectsContributionBase = table.Column<bool>(type: "bit", nullable: false),
                    AffectsBenefitsBase = table.Column<bool>(type: "bit", nullable: false),
                    AffectsWithholdingBase = table.Column<bool>(type: "bit", nullable: false),
                    IsBenefitRelated = table.Column<bool>(type: "bit", nullable: false),
                    AllowsRepeatInPeriod = table.Column<bool>(type: "bit", nullable: false),
                    MaxQuantity = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                    MaxAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    ApplicableClasses = table.Column<int>(type: "int", nullable: false),
                    RequiresDates = table.Column<bool>(type: "bit", nullable: false),
                    RequiresQuantity = table.Column<bool>(type: "bit", nullable: false),
                    RequiresAmount = table.Column<bool>(type: "bit", nullable: false),
                    IsAutomatic = table.Column<bool>(type: "bit", nullable: false),
                    ReducesWorkedDays = table.Column<bool>(type: "bit", nullable: false),
                    Origin = table.Column<int>(type: "int", nullable: false),
                    LegacyConceptId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InputsHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ...
                    TotalProvisions = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ...
                    AccountingDocumentId = table.Column<int>(type: "int", nullable: true),
                    ReversalAccountingDocumentId = table.Column<int>(type: "int", nullable: true),
                    ApprovedWithoutSegregation = table.Column<bool>(type: "bit", nullable: false),
                    ExceptionsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PublicId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstallmentsIssued = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayPeriodId = table.Column<int>(type: "int", nullable: false),
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    ConceptDefinitionId = table.Column<int>(type: "int", nullable: false),
                    ConceptCode = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    Quantity = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    ...
                    Origin = table.Column<int>(type: "int", nullable: false),
                    SupersedesNoveltyId = table.Column<int>(type: "int", nullable: true),
                    ...
                    RetroactiveOfPeriodId = table.Column<int>(type: "int", nullable: true),
                    LoanPortfolioId = table.Column<int>(type: "int", nullable: true),
                    CarriedFromNoveltyId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LegalParameterId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PAY_LegalParameterRanges_PAY_LegalParameters_LegalParameterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    PayrollPlanId = table.Column<int>(type: "int", nullable: false),
                    DaysWorked = table.Column<int>(type: "int", nullable: false),
                    SalaryTranchesJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ChangedFromPreviousRun = table.Column<bool>(type: "bit", nullable: false),
                    PublicId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevertReason = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    PublicId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PAY_PayrollPayments_PAY_PayrollRunEmployees_PayrollRunEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConceptDefinitionId = table.Column<int>(type: "int", nullable: false),
                    ConceptCode = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ConceptName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    Nature = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                    BaseAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Factor = table.Column<decimal>(type: "decimal(9,4)", precision: 9, scale: 4, nullable: true),
                    RangeFrom = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: true),
                    RangeTo = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: true),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    LegalParameterId = table.Column<int>(type: "int", nullable: true),
                    NoveltyId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PAY_PayrollRunLines_PAY_PayrollRunEmployees_PayrollRunEmployeeId",
                        column: x => x.PayrollRunEmployeeId,
                        principalSchema: "dbo",
                        principalTable: "PAY_PayrollRunEmployees",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PAY_PayslipDeliveries_PAY_PayrollRunEmployees_PayrollRunEmployeeId",
                        column: x => x.PayrollRunEmployeeId,
                        principalSchema: "dbo",
                        principalTable: "PAY_PayrollRunEmployees",
                        principalColumn: "Id",
            ...
            migrationBuilder.Sql($"""
                IF NOT EXISTS (SELECT 1 FROM [dbo].[PAY_PayrollPlans] WHERE [IsDefault] = 1)
                    INSERT INTO [dbo].[PAY_PayrollPlans]
                        ([Code], [Name], [Periodicity], [IsDefault], [IsActive],
                         [PublicId], [IsDeleted], [CreatedAt], [CreatedBy])
                    VALUES ('DEFAULT', N'Nómina general', 30, 1, 1,
                            NEWID(), 0, SYSUTCDATETIME(), '{MarcaDeOrigen}');

                UPDATE [dbo].[PAY_PayPeriods]
                   SET [PayrollPlanId] = (SELECT TOP 1 [Id] FROM [dbo].[PAY_PayrollPlans] WHERE [IsDefault] = 1)
