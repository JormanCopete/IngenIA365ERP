...
namespace IngenIA365ERP.Persistence.Migrations.SqlServer.Application
{
    ...
    /// autorizo el despliegue a produccion. Produccion corre PostgreSQL; este par SqlServer no se aplico
    /// en ningun ambiente y solo existe por la paridad de proveedores (Principio XII).
    ...
    public partial class RetiroDeVoucherTypeIdSombraEnDocumentos : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("UPDATE d SET d.[VoucherTypeId] = v.[Id] FROM [dbo].[ACC_Documents] AS d INNER JOIN [dbo].[ACC_VoucherTypes] AS v ON v.[Code] = d.[VoucherTypeCode];");
