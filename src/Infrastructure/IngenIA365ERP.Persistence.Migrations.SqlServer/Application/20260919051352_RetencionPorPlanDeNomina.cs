    ...
    public partial class RetencionPorPlanDeNomina : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropIndex(
                name: "IX_PAY_WithholdingParameters_PayrollCompanyId_UvtRangeStart_UvtRangeEnd",
                schema: "dbo",
            ...
            migrationBuilder.Sql(@"UPDATE dbo.[PAY_WithholdingParameters] SET [PayrollPlanId] = (SELECT TOP 1 [Id] FROM dbo.[PAY_PayrollPlans] WHERE [IsDefault] = 1 AND [IsDeleted] = 0 ORDER BY [Id]) WHERE [PayrollPlanId] = 0;");
