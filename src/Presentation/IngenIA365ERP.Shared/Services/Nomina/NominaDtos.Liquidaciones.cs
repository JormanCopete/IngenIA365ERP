...
public sealed record ExcluidoDeLiquidacionDto(Guid EmployeePublicId, string Name, string ReasonCode, string Reason)
{
    public string RazonTexto => ReasonCode switch
    {
        ...
        "RetiradoConDefinitiva" => "Retirado con definitiva (aprobada o en borrador)",
        "YaPagadaEnCorridaSemestral" => "Ya pagada en la prima semestral",
        "YaPagadaEnCorridaAnual" => "Ya pagadas en la corrida anual de cesantías",
        "NovedadNoLiquidable" => "Novedad que la definitiva no puede liquidar",
