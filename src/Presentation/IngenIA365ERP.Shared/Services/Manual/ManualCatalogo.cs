...
public static class ManualCatalogo
{
    ...
    private static List<TemaDeManual> Construir()
    {
        ...
        t.Add(Reporte("/reportes/comprobante-nomina", "Comprobante de nómina", Modulos.Reportes, "Comprobante de pago individual de un empleado en un período.", "Empleado y período de pago.", "comprobante", "desprendible", "nomina", "pago"));
