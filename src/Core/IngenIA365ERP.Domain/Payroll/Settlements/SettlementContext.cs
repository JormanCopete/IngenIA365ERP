...
public sealed class SettlementContext
{
    ...
    public static string ExclusionText(string reasonCode) => reasonCode switch
    {
        ...
        SettlementReasonCodes.YaPagadaEnCorridaSemestral => "La prima de este semestre ya se pagó en la corrida semestral aprobada antes de registrar el retiro: la definitiva no la liquida de nuevo (D-29).",
        SettlementReasonCodes.YaPagadaEnCorridaAnual => "Las cesantías y los intereses del año ya se pagaron en la corrida anual aprobada hasta su corte y el retiro no deja días posteriores: la definitiva no los liquida de nuevo (D-29).",
