...
public static class SettlementReasonCodes
{
    ...
    /// <summary>D-29: la prima del semestre ya la pagó la corrida semestral aprobada antes de registrar el retiro; la definitiva no la repite.</summary>
    public const string YaPagadaEnCorridaSemestral = "YaPagadaEnCorridaSemestral";

    /// <summary>D-29: las cesantías del año ya las pagó la corrida anual aprobada hasta su corte y no quedan días después de él.</summary>
