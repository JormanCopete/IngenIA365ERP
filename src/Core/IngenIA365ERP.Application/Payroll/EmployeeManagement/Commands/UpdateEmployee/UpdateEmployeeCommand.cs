...
public record UpdateEmployeeCommand : IRequest<Result>, IFichaPilaDian
{
    ...
    /// <summary>Etapa del aprendiz. Nula = no cambia; <see cref="ClearApprenticeStage"/> la quita (D-29).</summary>
    public ApprenticeStage? ApprenticeStage { get; init; }
    /// <summary>
    /// Deja la etapa en nulo (D-29): para quien pasó de aprendiz o pasante a otra clase y ya no la
