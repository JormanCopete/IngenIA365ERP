...
namespace IngenIA365ERP.Application.Accounting.VatTaxLines.Commands.UpdateVatTaxLine;

public record UpdateVatTaxLineCommand : IRequest<Result>
{
...
public class UpdateVatTaxLineCommandHandler(
    IApplicationDbContext context,
    IDateTimeService dateTime,
    ICurrentUserService currentUser)
    : IRequestHandler<UpdateVatTaxLineCommand, Result>
{
    public async Task<Result> Handle(
        UpdateVatTaxLineCommand request,
