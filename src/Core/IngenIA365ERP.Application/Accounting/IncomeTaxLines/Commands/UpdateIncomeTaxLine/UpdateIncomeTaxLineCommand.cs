...
namespace IngenIA365ERP.Application.Accounting.IncomeTaxLines.Commands.UpdateIncomeTaxLine;

public record UpdateIncomeTaxLineCommand : IRequest<Result>
{
...
public class UpdateIncomeTaxLineCommandHandler(
    IApplicationDbContext context,
    IDateTimeService dateTime,
    ICurrentUserService currentUser)
    : IRequestHandler<UpdateIncomeTaxLineCommand, Result>
{
    public async Task<Result> Handle(
        UpdateIncomeTaxLineCommand request,
