...
public static class CatalogoDePlantillas
{
    ...
    [
        ...
        new(3, Def(UnidadesClave, "Unidades de medida", ModuloDeAuditoria.Inventory, Datos),
            "/api/inventory/units", "ImportUnitsOfMeasureCommand", EntregaDelComercio.I1, EntregaDelComercio.I1,
            "Inventory.Catalog.View", "Inventory.Catalog.Import"),
        new(4, Def(MarcasClave, "Marcas", ModuloDeAuditoria.Inventory, Datos),
            "/api/inventory/brands", "ImportBrandsCommand", EntregaDelComercio.I1, EntregaDelComercio.I1,
            "Inventory.Catalog.View", "Inventory.Catalog.Import"),
        new(5, Def(CategoriasClave, "Categorías", ModuloDeAuditoria.Inventory, Datos),
            "/api/inventory/product-categories", "ImportProductCategoriesCommand", EntregaDelComercio.I1, EntregaDelComercio.I1,
            "Inventory.Catalog.View", "Inventory.Catalog.Import"),
        new(6, Def(ProductosClave, "Productos (con códigos de barras y conversiones)", ModuloDeAuditoria.Inventory,
                "Productos", "CodigosDeBarras", "Unidades", "ImpuestosAdicionales"),
        ...
        new(7, Def(BodegasClave, "Bodegas y ubicaciones", ModuloDeAuditoria.Inventory, "Bodegas", "Ubicaciones"),
        ...
        new(10, Def(PuntosDeVentaClave, "Puntos de venta y cajas", ModuloDeAuditoria.Inventory, "PuntosDeVenta", "Cajas"),
        ...
        new(11, Def(MediosDePagoClave, "Medios de pago (con franquicias, adquirentes y datáfonos)", ModuloDeAuditoria.PaymentMeans,
                "Franquicias", "Adquirentes", "Datafonos", "MediosDePago"),
        ...
        new(12, Def(ListasDePreciosClave, "Listas de precios", ModuloDeAuditoria.Inventory, "Listas", "Precios"),
        ...
        new(13, Def(TopesDeDescuentoClave, "Topes de descuento", ModuloDeAuditoria.Inventory, Datos),
