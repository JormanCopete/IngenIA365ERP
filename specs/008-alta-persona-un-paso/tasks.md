...
- [ ] T056 Merge a `develop` (dos PR: **componente + Personas + servidor** primero, **Empleados + Asociados** después), CI verde (~9 min), Argo DEV/QA; verificación en QA con Operador / sólo lectura / rol personalizado / cambio de cooperativa (quickstart §4)
