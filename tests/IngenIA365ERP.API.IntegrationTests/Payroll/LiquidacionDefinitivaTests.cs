...
public class LiquidacionDefinitivaTests(CentralIdentityApiFixture fx)
{
    ...
    public async Task Ciclo_completo_de_la_definitiva_por_HTTP()
    {
        ...
        // D-28: la quincena del retiro (1 al 15) tampoco lo trae: SALARIO_PENDIENTE ya pagó esos días en la definitiva, una sola vez.
        ...
        empleadosQ1.EnumerateArray().Should().NotContain(e => e.GetProperty("employeePublicId").GetGuid() == empleadoId, "la definitiva aprobada pagó del 1 al 15 como salario pendiente (D-28)");
