...
/// reversión se rechaza (D-32: primero se reversa esa nómina); descartar el borrador anula el
...
public class ReverseVacationCommandHandlerTests
{
    ...
    {
        // D-32. Hasta el 2026-09-21 la reversión pasaba en silencio: la novedad de julio quedaba activa en un
