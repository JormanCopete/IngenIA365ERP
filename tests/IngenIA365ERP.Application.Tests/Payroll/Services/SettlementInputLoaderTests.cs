...
public class SettlementInputLoaderTests
{
    ...
    /// <summary>
    /// D-28: una terminación registrada (definitiva en borrador) también saca al empleado de la prima
    ...
    /// <summary>
    /// D-28, el otro sentido: la definitiva registrada después de aprobar la prima semestral o la corrida
    ...
    /// <summary>
    /// D-28: la definitiva trae las novedades activas del empleado en el período abierto donde cae el
