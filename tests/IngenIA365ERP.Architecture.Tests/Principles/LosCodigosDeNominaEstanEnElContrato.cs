...
/// <summary>
/// Feature 010 (D-30): el contrato <c>contracts/api.md</c> es la fuente de verdad de los códigos de
...
public class LosCodigosDeNominaEstanEnElContrato
{
    ...
    public void Todo_codigo_Payroll_emitido_por_Application_Payroll_figura_en_el_contrato()
    {
        ...
        Assert.True(faltantes.Count == 0,
            "Códigos Payroll.* que la API emite y ningún contrato registra (D-30: contracts/api.md §3.6 o la sección del recurso):\n  "
            + string.Join("\n  ", faltantes));
    }
