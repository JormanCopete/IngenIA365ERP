...
public class LasPantallasDeNominaSiguenAlContrato
{
    ...
    {
        // D-40: «Registrar disfrute o compensación» cruza dos endpoints con permisos distintos —la vista
        ...
        Assert.True(incompletos.Count == 0, "Botones de registro sin todos los gates de los endpoints que cruza (D-40):\n  " + string.Join("\n  ", incompletos));
