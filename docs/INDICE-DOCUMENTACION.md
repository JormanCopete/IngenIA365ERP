...
| `docs/operaciones/despliegue-adjuntos-directos.md` | **El documento a tener delante al llevar la feature 011 a producción.** Producción todavía guarda los adjuntos en el disco del nodo. Qué sube (con las correcciones que esperan en develop), por qué conviene entrar directo con credenciales temporales —y desactivar ya la llave filtrada, que no usa nadie—, qué mirar antes (adjuntos en el disco: 0 el 2026-09-23), el orden, la verificación y el rollback. |
