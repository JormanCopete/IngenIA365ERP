...
| ⏳ M10 | **`ALTER ROLE ingenia CREATEDB`** en los tres clústeres `erp-db` | ✅ DEV y QA el 2026-09-04 (primera cooperativa aprovisionada en QA en `Ready`) · ⏳ PDN antes de registrar la primera cooperativa real. Ver P13 en [estado-y-pendientes.md](estado-y-pendientes.md) |
