...
Marque cada compuerta como `PASS` / `FAIL` / `N/A` con una nota breve. Cualquier
`FAIL` debe documentarse en `Complexity Tracking` con justificación, o el plan se
rechaza. Las compuertas derivan directamente de `.specify/memory/constitution.md`.
...
| VIII | Validación dual (frontend + FluentValidation en Command)          |        |      |
| IX   | Errores visibles (sin try/catch silenciados; Serilog + notificación) |        |      |
